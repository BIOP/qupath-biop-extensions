...
/**
 * Container for various options that can customize the behavior of the {@link OmeroRawServer}.
 *
 * @author Pete Bankhead
 *
 */
public class OmeroRawServerOptions {
    ...
    private static OmeroRawServerOptions instance = new OmeroRawServerOptions();
...
//	private boolean requestChannelZCorrectionVSI = false;
     ...
     * @return
     */
    public static OmeroRawServerOptions getInstance() {
        return instance;
    }
