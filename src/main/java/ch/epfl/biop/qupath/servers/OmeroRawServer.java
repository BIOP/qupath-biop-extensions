package ch.epfl.biop.qupath.servers;
/*-
 * #%L
...
import ch.epfl.biop.qupath.servers.utils.OmeroTools;
 ...
 *
 */
public class OmeroRawServer extends AbstractTileableImageServer {

    private static final Logger logger = LoggerFactory.getLogger(OmeroRawServer.class);
     ...
     */
    private OmeroRawServerOptions options;

    /**
     * Manager to help keep multithreading under control.
     */
    private static OmeroReaderManager manager = new OmeroReaderManager();
...
//	private boolean parallelizeMultichannel = true;
     ...
     */
    public OmeroRawServer(final URI uri, String...args) throws FormatException, IOException, DependencyException, ServiceException, URISyntaxException {
...
// TODO START HERE Again
    OmeroRawServer(Long imageID, final OmeroRawServerOptions options, String...args) throws FormatException, IOException, DependencyException, ServiceException, URISyntaxException, ServerError, DSOutOfServiceException {
        ...
        // Parse the arguments
        var bfArgs = OmeroRawArgs.parse(args);
                    ...
                    if (reader.getResolutionCount() == 1 && (
                        ...
                        if (imageMap.containsKey(name))
                            ...
                            imageMap.put(name, DefaultImageServerBuilder.createInstance(
                                    OmeroRawServerBuilder.class, null, uri,
                                    new OmeroRawArgs(s, readerOptions).backToArgs()
                            ));
                        }
                    }
...
//					args(args).
    ...
    public OmeroRawServer(URI uri, OmeroRawServerBuilder.OmeroWebClient client, String[] args) throws IOException {
        //TODO
    }
    ...
    protected ServerBuilder<BufferedImage> createServerBuilder() {
        return DefaultImageServerBuilder.createInstance(OmeroRawServerBuilder.class, getMetadata(), uri, args);
    }
...
//	}
    ...
    static class OmeroRawArgs {
        ...
        OmeroRawArgs(int series, Map<String, String> readerOptions) {
            this.series = series;
        ...
        static OmeroRawArgs parse(String[] args) {
            var bfArgs = new OmeroRawArgs();
