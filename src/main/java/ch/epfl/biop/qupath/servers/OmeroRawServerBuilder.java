 ...
 *
 */
public class OmeroRawServerBuilder implements ImageServerBuilder<BufferedImage> {

    final private static Logger logger = LoggerFactory.getLogger(OmeroRawServerBuilder.class);
    ...
    public ImageServer<BufferedImage> buildServer(URI uri, String...args) {
        if (canConnectToOmero(uri, args)) {
            try {
                ...
                return new OmeroRawServer(uri, client, args);
            } catch (IOException e) {
